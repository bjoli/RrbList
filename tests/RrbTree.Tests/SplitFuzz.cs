...
public class SplitFuzz
{
    ...
    public void FuzzTestSplit()
    {
        ...
        for (var i = 0; i < iterations; i++)
        {
            ...
            var size = random.Next(0, 5000); // Test empty, small, and medium lists
            ...
            var splitIndex = random.Next(0, size + 1);
    ...
    private void AssertCollectionsEqual(List<int> expected, RrbList<int> actual, string side, int iter, int splitIdx,
        int totalSize)
    {
